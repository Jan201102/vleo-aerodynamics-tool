%% AERODYNAMIC damping
% calculate the aerodynamic damping for a satellite for different control surface configurations
...
for model = 1:2
    for i = 1:num_angles
        ...
        aero_damping(i,model) = calculate_aerodynamic_damping(derivation_method, ...
                                                                delta_q_rad_per_s, ...
                                                                axis_direction,...
                                                                torque_component, ...
                                                                bodies, ...
...
legend(sprintf('Sentman \\alpha_E = %.4f',environment_definitions.energy_accommodation), 'IRS model');
