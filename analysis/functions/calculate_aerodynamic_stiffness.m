function stiffness = calculate_aerodynamic_stiffness(method, alpha_zero, delta__rad, axis_dir_B, component, bodies, bodies_rotation_angles__rad, model, lut_data)
...
%   calculated at the specified rotation axis and component
    ...
    switch method
        case 'central'
            ...
            torque_plus = compute_aerodynamics_at_angle(alpha_zero+delta__rad, axis_dir_B, bodies, bodies_rotation_angles__rad, model, lut_data);
            torque_minus = compute_aerodynamics_at_angle(alpha_zero-delta__rad, axis_dir_B, bodies, bodies_rotation_angles__rad, model, lut_data);
        ...
        case 'five_point_stencil'
            ...
            torque_1 = compute_aerodynamics_at_angle(alpha_zero-2*delta__rad, axis_dir_B, bodies, bodies_rotation_angles__rad, model, lut_data);
            torque_2 = compute_aerodynamics_at_angle(alpha_zero-delta__rad, axis_dir_B, bodies, bodies_rotation_angles__rad, model, lut_data);
            torque_3 = compute_aerodynamics_at_angle(alpha_zero+delta__rad, axis_dir_B, bodies, bodies_rotation_angles__rad, model, lut_data);
            torque_4 = compute_aerodynamics_at_angle(alpha_zero+2*delta__rad, axis_dir_B, bodies, bodies_rotation_angles__rad, model, lut_data);
        ...
        case 'seven_point_stencil'
            ...
            torque_1 = compute_aerodynamics_at_angle(alpha_zero-3*delta__rad, axis_dir_B, bodies, bodies_rotation_angles__rad, model, lut_data);
            torque_2 = compute_aerodynamics_at_angle(alpha_zero-2*delta__rad, axis_dir_B, bodies, bodies_rotation_angles__rad, model, lut_data);
            torque_3 = compute_aerodynamics_at_angle(alpha_zero-delta__rad, axis_dir_B, bodies, bodies_rotation_angles__rad, model, lut_data);
            torque_4 = compute_aerodynamics_at_angle(alpha_zero+delta__rad, axis_dir_B, bodies, bodies_rotation_angles__rad, model, lut_data);
            torque_5 = compute_aerodynamics_at_angle(alpha_zero+2*delta__rad, axis_dir_B, bodies, bodies_rotation_angles__rad, model, lut_data);
            torque_6 = compute_aerodynamics_at_angle(alpha_zero+3*delta__rad, axis_dir_B, bodies, bodies_rotation_angles__rad, model, lut_data);
        ...
        case 'forward'
            ...
            torque_0 = compute_aerodynamics_at_angle(alpha_zero, axis_dir_B, bodies, bodies_rotation_angles__rad, model, lut_data);
            torque_plus = compute_aerodynamics_at_angle(alpha_zero+delta__rad, axis_dir_B, bodies, bodies_rotation_angles__rad, model, lut_data);
